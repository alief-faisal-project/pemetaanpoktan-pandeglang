...
import { getDistricts } from "@/data/farmerGroups";
      ...
      <div className="container py-8">
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-2">
            ...
            >
              <FontAwesomeIcon icon={faBuilding} className="h-6 w-6 text-primary" />
            </motion.div>
            <div>
              <motion.h1 
              ...
              >
                {districts.length} kecamatan di Kabupaten Pandeglang
              </motion.p>
            </div>
          </div>
        </motion.div>
